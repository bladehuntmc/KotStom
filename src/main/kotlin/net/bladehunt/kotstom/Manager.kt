...
object Manager {
    ...
    inline val packetListener: PacketListenerManager get() = PacketListenerManager
    @Deprecated("As of 0.1.0-beta.2", ReplaceWith("ExceptionManager"))
    inline val exception: ExceptionManager get() = ExceptionManager
    @Deprecated("As of 0.1.0-beta.2", ReplaceWith("ConnectionManager"))
    inline val connection: ConnectionManager get() = ConnectionManager
    @Deprecated("As of 0.1.0-beta.2", ReplaceWith("InstanceManager"))
    inline val instance: InstanceManager get() = InstanceManager
    @Deprecated("As of 0.1.0-beta.2", ReplaceWith("BlockManager"))
    inline val block: BlockManager get() = BlockManager
    @Deprecated("As of 0.1.0-beta.2", ReplaceWith("CommandManager"))
    inline val command: CommandManager get() = CommandManager
    @Deprecated("As of 0.1.0-beta.2", ReplaceWith("RecipeManager"))
    inline val recipe: RecipeManager get() = RecipeManager
    @Deprecated("As of 0.1.0-beta.2", ReplaceWith("TeamManager"))
    inline val team: TeamManager get() = TeamManager
    @Deprecated("As of 0.1.0-beta.2", ReplaceWith("SchedulerManager"))
    inline val scheduler: SchedulerManager get() = SchedulerManager
    @Deprecated("As of 0.1.0-beta.2", ReplaceWith("BenchmarkManager"))
    inline val benchmark: BenchmarkManager get() = BenchmarkManager
    @Deprecated("As of 0.1.0-beta.2", ReplaceWith("DimensionTypeManager"))
    inline val dimensionType: DimensionTypeManager get() = DimensionTypeManager
    @Deprecated("As of 0.1.0-beta.2", ReplaceWith("BiomeManager"))
    inline val biome: BiomeManager get() = BiomeManager
    @Deprecated("As of 0.1.0-beta.2", ReplaceWith("AdvancementManager"))
    inline val advancement: AdvancementManager get() = AdvancementManager
    @Deprecated("As of 0.1.0-beta.2", ReplaceWith("BossBarManager"))
    inline val bossBar: BossBarManager get() = BossBarManager
    @Deprecated("As of 0.1.0-beta.2", ReplaceWith("GlobalEventHandler"))
    inline val globalEvent: GlobalEventHandler get() = GlobalEventHandler
}
...
inline val BenchmarkManager: BenchmarkManager get() = getBenchmarkManager()
inline val DimensionTypeManager: DimensionTypeManager get() = getDimensionTypeManager()
inline val BiomeManager: BiomeManager get() = getBiomeManager()
